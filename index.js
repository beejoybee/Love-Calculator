...
document.querySelector("button").onclick = function handleClick(event) {
 ...
 if (loveScore >= 70) {
   var perfectScore = document.querySelector("h3").innerHTML =  "Your love score is " + loveScore + ", you are a perfect pair!";
   ...
   var mediumScore = document.querySelector("h3").innerHTML = "Your love score is " + loveScore + ", you'll need to work to make it work.";
   var heart2 = document.querySelector("img").setAttribute("src", "images/heart2.png");
   return mediumScore, heart2;
 } else {
   var badScore = document.querySelector("h3").innerHTML = "Your love score is " + loveScore + ", save yourself the heartache.";
